...
function intro (text){
    ...
    matrixbg.id="matrix";
    matrixbg.style.color="#C0C0C0";
    matrixbg.style.backgroundColor = "#000000";
    ...
    window.setTimeout(function(){text.style.letterSpacing="0px";window.setTimeout(function(){matrixbg.removeChild(text);matrixbg.style.color = "#000000"; matrix()}, 12000)}, 1000)}
...
function animateMatrix (){
    ...
    var matrixbg = document.getElementById("matrix");
    try{matrixrows[selRow][selmxpoi[selRow][0]-selmxpoi[selRow][1]].style.color="#000000";}catch(err){}
    try{matrixrows[selRow][selmxpoi[selRow][0]-1].style.color="#00ff00";}catch(err){}
    matrixrows[selRow][selmxpoi[selRow][0]].style.color = "#ffffff";
    selmxpoi[selRow][0]++
    }
    else{
        matrixrows[selRow][matrixrowheight-1].style.color = "#00ff00";
        matrixrows[selRow][selmxpoi[selRow][0]-selmxpoi[selRow][1]].style.color="#000000";
        selmxpoi[selRow][1]--;
